...
static struct opt_struct options[]={
	...
	{PAR(dump_dhat),"<filename>","Dump the frequency-domain interaction matrix (D_hat) to a binary file after "
		"initialization. Used for spectral preconditioner export.",1,NULL},
